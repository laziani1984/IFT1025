...
public class NonKitten extends Case {
    ...
    /**
     * (String[]) descriptions : Un tableau descriptions qui contient tous les commentaires qui seront affichés lors de l'interaction de l'objet nonKitten avec le robot.
     * (String) description : Une chaine des caractères description pour le commentaire lié à chaque objet instancié.
     * (ArrayList<String>) cpieDescriptions : Un arrayList de type String qui contiendra une copie du tableau original pour ne pas modifier le tableau initial.
     * (Int) index : Pour avoir une séléction randomiser lors de l'assignation d'un élément de l'arrayList à chaque objet instancié.
     */
    ...
    private ArrayList<String> cpieDescriptions = copierTab(descriptions);
    private int index = (int) (Math.random() * cpieDescriptions.size());


    /**
     * Le constructeur de la classe, il sera utilisé pour donner un symbole et une description aléatoires au élément.
     */
    public NonKitten() {

        this.representation = getRandomSymbole();
        this.description = cpieDescriptions.remove(index);
    }


    /**
     * @param robot Le robot qui interagirait avec la case.
     * @return Reoturne toujours vrai puisque l'intéraction entre le robot et la case est toujours valide.
     */
    @Override
    ...
    /**
     * Cette méthode va rien retourner, elle va juste afficher un commentaire.
     *
     * @param robot Le robot va interagir avec les nonKitten pour afficher le commentaire lié au case nonKitten.
     */
    @Override
